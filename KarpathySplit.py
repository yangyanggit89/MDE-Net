...
val = json.load(open("D:\\shuju\\coco2014\\annotations\\captions_val2014.json", 'r'))
train = json.load(open("D:\\shuju\\coco2014\\annotations\\captions_train2014.json", 'r'))
...
for subset in split:
    ...
    json.dump(json_data[subset], open('karpathy_split_' + subset + '.json', 'w'))
