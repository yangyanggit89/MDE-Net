...
from transformer_swin1.models import Transformer
...
def main(args):
    ...
    # 初始化优化器，默认学习率为0.0003
    optimizer = torch.optim.AdamW(decoder.parameters(), lr=0.00003)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='onlyma6best1', help='path for saving trained models')
    ...
    parser.add_argument('--num_epochs', type=int, default=7)  # 设置为7轮
    parser.add_argument('--batch_size', type=int, default=40)
    parser.add_argument('--num_workers', type=int, default=12)
    parser.add_argument('--learning_rate', type=float, default=0.000001)
    parser.add_argument('--warmup', type=int, default=10000)
    parser.add_argument('--encoder_path', type=str, default='mfa/encoder-6.ckpt', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='mfa/decoder-6.ckpt', help='path for trained decoder')
